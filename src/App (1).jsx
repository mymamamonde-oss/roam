...
Return this JSON (fill every field):
{
  ...
  "packingList": [
    { "emoji": "🎒", "item": "generic searchable product type (2-4 words, no brand names)", "reason": "the specific reason it earns its place on THIS trip" }
  ],
...
- Max 5 packing items
- PACKING ITEMS: each "item" must be a GENERIC, searchable product type a parent could buy on Amazon — 2-4 plain words, NO brand names, NO model names, NO hyper-specific descriptors (good: "toddler UV swimsuit", "portable blackout blind", "lightweight travel stroller", "kids ear defenders"; bad: "Brand SunSmart UPF50+ ruffle romper", "XYZ EZ-Fold deluxe buggy"). Put all the specificity in the "reason" instead — tie it to this exact trip's terrain, climate, season, ages, and pace (e.g. "cobblestone old towns make a stroller painful", "August beach sun + your 2-year-old", "long museum days, little legs tire fast").
- 3 family tips
